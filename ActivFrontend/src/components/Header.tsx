...
//           className="flex items-center gap-1 bg-transparent border-none cursor-pointer text-left"
...
//       {/* Mobile nav panel */}
//       {menuOpen && (
//         <nav className="mx-auto mt-2 flex max-w-6xl flex-col gap-1 rounded-2xl border border-white/10 bg-[#000000] p-3 backdrop-blur-md md:hidden">
//           {NAV_LINKS.map((link) => {
//             const isActive = currentPage === link.view;
//             return (
//               <button
